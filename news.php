				  ...
				  <ul class="nav nav-sidebar">
					...
					<li><a href="#" class="menu1"><span class="glyphicon glyphicon-film" aria-hidden="true"></span>Movies<span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span></a></li>
						<ul class="cl-effect-2">
							<li><a href="music.php">English</a></li>
							<li><a href="music.php">Chinese</a></li>
							<li><a href="music.php">Hindi</a></li>
						</ul>
						<!-- script-for-menu -->
						<script>
					...
					<li><a href="music.php" class="song-icon"><span class="glyphicon glyphicon-music" aria-hidden="true"></span>Songs</a></li>
					...
					<div class="footer-top">
						<div class="footer-top-nav">
							<ul>
								...
								<li><a href="faqs.php">Developers</a></li>
							</ul>
						</div>
